...
} & Omit<BaseInputProps, 'onChangeText'>;

export const FormDateInput = React.forwardRef<any, FormDateInputProps>(
  (
    {
      title,
      containerStyle,
    ...
    const styles = FormDateInputStyles();
...
export const FormDateInputStyles = () =>
  useTheme(({ colors }) => ({
    inputContainer: {
